...
* Advanced filtering & Joins - Connecting tables using 'INNER JOIN', 'LEFT JOIN', 'RIGHT JOIN' on specific criteria.
* Aggregate Functions & Grouping - Extracting summarized data using 'GROUP BY' performing mathematical functions like 'COUNT()', 'SUM()', 'MIN()', 'MAX()', 'AVG()', 'HAVING'.
  
**# Conditional Logic**
Used 'CASE WHEN'  - Checks data conditions line-by-line and outputs a custom value when a condition is met.
